...
import { SendGawean, SendRevision } from '../../components/modal/SendGawean';

export default class PartnerOrderDetail extends Component {
  constructor() {
    super();
  ...
  render() {
    ...
    return (
      <div>
        <Head title="Order Detail (Partner) " description="Detail order" />
        <HeaderNav />
        <Container fluid>
          <Row className="justify-content-center mt-5">
            ...
            >
              ...
              {/* Gawean starts card start here */}
              <Card className="card__custom_order mt-5">
                <Card.Body>
                  <div className="card__custom_order_global text-center">
                    <img
                      src={imagePath('start-up.png')}
                      alt=""
                      className="mb-3"
                    />
                    <h3 className="mb-3">GAWEAN DIMULAI</h3>
                    <p>
                      Gawean dimulai waktu pengerjaan telah dimulai. Semangat!
                    </p>
                  </div>
                </Card.Body>
              </Card>

              {/* Gawean detail starts here */}
              <Accordion>
                <Card className="card__custom_order mt-5">
                  <Card.Body>
              ...
              <Card className="mt-5 mb-5 card__custom_order">
                <Card.Body className="p-3">
                  ...
                  <h4 className="mt-3 text-center font-weight-bold text-uppercase">
                    yes, gaweanmu sudah terkirim ke klienmu!
                  </h4>
                  <p className="mt-3 text-center">
                    Tunggu respon klien, apabila klienmu tidak merespon dalam 2
                    hari maka gaweanmu akan dianggap selesai
                  </p>
                ...
                <Card.Body>
                  <div className="card__custom_order_global text-center">
                    <img
                      ...
                      className="mb-3"
                    />
                    <h3 className="mb-3">YEAY!!! GAWEANMU TELAH SELESAI</h3>
                    <p>SILAHKAN CEK ULASAN KLIEN ATAS GAWEANMU</p>
                  </div>
                </Card.Body>
              </Card>
            </Col>
            ...
            <Col className="p-3 p-lg-0 mb-3" xs={12} md={10} lg={2}>
              <SendGawean type="revision" />
              <Card className="card__custom_order px-5 py-3">
                <p className="text-center">
                  Perlu mengubah atau membatalkan pesanan?
                </p>
                <div className="btn__order-right">
                  <NavLink to="/pusat-resolusi">Pusat Resolusi</NavLink>
                </div>
              </Card>
            </Col>
          </Row>
